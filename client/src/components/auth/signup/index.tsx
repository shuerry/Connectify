    ...
    <div className='auth-container'>
        ...
        <form className='auth-form' onSubmit={handleSubmit}>
          <div className='form-group'>
            ...
            <input
              ...
              id='username-input'
            />
            <div className='form-hint'>Choose a username that represents you in the community</div>
          </div>
      ...
      <LegalModal isOpen={showTerms} onClose={() => setShowTerms(false)} title='Terms of Service'>
        <div>
          ...
          <p>
            Users can create private communities with restricted access. Community creators act as
            moderators and community-specific rules may apply.
          </p>

          <h2>6. User Safety and Security</h2>
          <p>
            Use strong, unique passwords, never share personal information publicly, and report
      ...
      <LegalModal isOpen={showPrivacy} onClose={() => setShowPrivacy(false)} title='Privacy Policy'>
        <div>
          ...
          <p>
            ...
            enable communication between users, and moderate content.
          </p>

          <h2>3. Information Sharing and Disclosure</h2>
          <p>
            Your username and public content is visible to other users. We keep your email address,
            direct messages, and account settings private.
          </p>

          <h2>4. Data Security</h2>
          <p>
            Passwords are encrypted, data transmission is protected with SSL/TLS encryption, and we
            conduct regular security audits.
          </p>

          <h2>5. Your Privacy Rights</h2>
          <p>
            You have the right to view, update, or delete your personal data. You can control
