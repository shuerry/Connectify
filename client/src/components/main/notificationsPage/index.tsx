    ...
    <div className='notif-page'>
      ...
      {items.length === 0 && !loading && (
        <div className='notif-empty'>
          <div className='notif-empty__icon' aria-hidden>
            🔔
          </div>
          <h2>All caught up</h2>
      ...
      <ul className='notif-list'>
        {items.map(n => (
          <li key={n._id} className={`notif-card ${n.isRead ? 'is-read' : 'is-unread'}`}>
            ...
            <div className='notif-card__content'>
              <div className='notif-card__top'>
                <h3 className='notif-card__title'>{n.title ?? `${n.kind} update`}</h3>
